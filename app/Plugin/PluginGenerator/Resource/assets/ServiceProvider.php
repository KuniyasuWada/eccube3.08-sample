...
class [code]ServiceProvider implements ServiceProviderInterface
{
    public function register(BaseApplication $app)
    {
        ...
        // 独自コントローラ
        $app->match('/plugin/[code]/hello', 'Plugin\[code]\Controller\[code]Controller::index')->bind('plugin_[code]_hello');
        ...
        // ログファイル設定
        $app['monolog.plugin.[code]'] = $app->share(function ($app) {

            $logger = new $app['monolog.logger.class']('plugin.[code].client');
