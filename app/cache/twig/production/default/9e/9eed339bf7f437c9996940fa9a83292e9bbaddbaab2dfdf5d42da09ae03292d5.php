...
/* block.twig */
class __TwigTemplate_b3ea82eaec6225f19fac2de3a0c10671be870600db0c56b05fc2fd97346250ef extends Twig_Template
{
    ...
    ";
            ...
            if ($this->getAttribute($context["Block"], "logic_flg", array())) {
                // line 25
                echo "        ";
                echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('routing')->getPath(("block_" . $this->getAttribute($context["Block"], "file_name", array()))));
                echo "
    ";
            } else {
                // line 27
